...
- Rows: 50000
- Columns: 7  
- Variable types: double and character
...
car_data_tb <- as_tibble(car_data)
car_data_tb
...
select(car_data_tb, Model, Mileage)
# Select Manufacturer, Price, and Fuel type
select(car_data_tb, Manufacturer, Price, 'Fuel type')
...
**Your answer:** [Thera is a space in 'Year of manufacture']
...
car_data <- mutate(car_data, mileage_per_year = Mileage / year)
...
car_data <- car_data %>% 
  mutate(car_data, price_category = case_when(
    Price < 15000 ~ 'budget',
...
filter(car_data, price_category == "high", Mileage < 20000)
```
